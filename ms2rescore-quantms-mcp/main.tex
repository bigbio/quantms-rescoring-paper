...
%RG A schematic showing how the different tools are integrated and relate to each other would be a nice to have (just a suggestion, no requirement at all). For instance: https://github.com/nf-core/mhcquant/blob/master/assets/mhcquant_subway.png
