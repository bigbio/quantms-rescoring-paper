...
\author[8,9]{Lennart Martens}
\author[7,11,12]{Oliver Kohlbacher}
\author[10]{Mingze Bai}
\author[11,7]{Timo Sachsenberg}
...
\affil[8]{CompOmics, VIB Center for Medical Biotechnology, VIB, Ghent, Belgium}
\affil[9]{Department of Biomolecular Medicine, Faculty of Medicine and Health Sciences, Ghent University, Ghent, Belgium}
\affil[10]{Chongqing Key Laboratory of Big Data for Bio Intelligence, Chongqing University of Posts and Telecommunications, Chongqing, China}
\affil[11]{Department of Computer Science, Applied Bioinformatics, University of Tübingen, Tübingen, Germany}
\affil[12]{Institute for Translational Bioinformatics, University Hospital Tuebingen, Tübingen, Germany}
